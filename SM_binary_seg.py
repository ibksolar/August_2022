...
wandb.config = {
  ...
  "base_dir":base_dir, "img_channels":img_channels,
...
train_datagen = my_image_mask_generator(image_generator, mask_generator)
...
if not load_prev_model:
    ...
    model.compile('Adam', loss=sm.losses.bce_jaccard_loss, metrics=['accuracy', sm.metrics.iou_score])
    print(model.summary())
...
model_save_path = f'{base_dir}/SM_Binary_segmentation/SM_{iou_score*100: .2f}_{time_stamp}.h5'
