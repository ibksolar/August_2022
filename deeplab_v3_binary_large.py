...
def DeeplabV3Plus(image_size, num_classes):
    model_input = keras.Input(shape=image_size,dtype=tf.float64)
    
    # input_tensor = layers.Conv2D(3,3, padding='same', activation = 'relu')(model_input)
    ...
    model_output = layers.Conv2D(num_classes, kernel_size=(1, 1), padding="same",dtype=tf.float64)(x) #, activation='softmax'
