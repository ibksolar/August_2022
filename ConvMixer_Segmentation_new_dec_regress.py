...
model_name = 'ConvMixer_decimated_regress_April23'

use_wandb = True
time_stamp = '22_April_23_0135' #datetime.strftime( datetime.now(),'%d_%B_%y_%H%M')
...
def read_mat(filepath):
    def _read_mat(filepath):
        ...
        layer = tf.cast( tf.cast(mat_file['new_raster'], dtype=tf.bool), dtype=tf.float64)
...
# =============================================================================
## Same function as above but just for multi-input reading for Convolution and Regression
...
def get_conv_mixer_256_8(
    ...
    combined_out = layers.Conv2D( 1, (1,1), padding="same",activation='sigmoid', name= "raster3D", dtype = tf.float64)(combined_out) # activation='sigmoid',
