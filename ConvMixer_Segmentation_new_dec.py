...
model_name = 'ConvMixer_decimated_April23'
...
if use_wandb:    
    ...
    wandb.init( project="my-test-project", entity="ibksolar", name='ConvMixer_dec'+time_stamp,config ={})
    config = wandb.config
else:
    config ={}
...
# Hyperparameters
config['Run_Note'] = 'ConvMixer_Segmentation_large with Dropout 0.4'
config['batch_size'] = 4
