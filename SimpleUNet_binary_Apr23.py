...
callbacks = [
   ModelCheckpoint(f"{config['base_path']}//{model_name}//SimpleUNet_Checkpoint{time_stamp}.h5", save_best_only=True, monitor="val_loss"),
...
model.save(f"{config['base_path']}//{model_name}//SimpleUNet_acc_2023{acc:.2f}_{time_stamp}.h5")
